      ...
      <div className="container mx-auto px-4">
        <div className="min-h-[80vh] md:min-h-[150vh] relative perspective-[1000px] pb-[15vh] md:pb-[30vh]">
          {teasers.map((teaser, index) => (
            <Card 
              key={index} 
              className={`bg-white border-none p-4 sm:pl-8 sm:pt-8 sm:pb-8 sm:pr-[22rem] rounded-2xl flex flex-col md:flex-row gap-4 md:gap-8 items-center sticky top-[15vh] transition-transform duration-300 overflow-hidden ${
