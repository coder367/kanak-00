...
const CountdownTimer = () => {
  ...
  const timeBoxStyle = "bg-[#BC1444]/80 backdrop-blur-sm rounded-lg p-2 md:p-5 flex flex-col items-center justify-center min-w-[60px] sm:min-w-[80px] md:min-w-[90px] shadow-lg";
  ...
  return (
    <div className="flex gap-2 md:gap-5 justify-between w-full max-w-[400px] mx-auto">
