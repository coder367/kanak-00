...
const CountdownTimer = () => {
  ...
  const timeBoxStyle = "bg-disco-dark backdrop-blur-sm rounded-lg p-3 flex flex-col items-center justify-center min-w-[70px] md:min-w-[80px]";
  const numberStyle = "text-xl md:text-2xl lg:text-3xl font-bold text-white font-garamond";
