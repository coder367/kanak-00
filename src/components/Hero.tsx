...
export const Hero = ({ onScroll, brandRef }: HeroProps) => {
  ...
  return (
    <div 
      className="min-h-[130vh] flex flex-col items-center justify-start pt-16 md:pt-32 relative overflow-hidden" 
      ref={observerRef}
      style={{
    ...
    >
      ...
      <div className="absolute top-[40%] left-0 right-0 z-[40]">
        <CurvedFeatureGrid />
      </div>

      {/* Launching Soon and Timer Container */}
      <div className="absolute bottom-40 left-0 right-0 z-[40] px-4 flex flex-col items-center">
        {/* Launching Soon Tag */}
